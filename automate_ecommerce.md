# Ecommerce automated deploy

A script for automating the deployment of the example ecommerce web application in KodeCloud's beginner courses (DB and Web in same server).
